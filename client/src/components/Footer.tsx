    ...
    <div className="bg-black py-30">
      <div className="flex items-center justify-center ml-2 gap-5">
        <BsFillPatchQuestionFill
          color="orange"
          className="cursor-pointer border-2 border-white rounded-sm shadow-[4px_4px_0_#fff] bg-white roudned-lg size-9 -rotate-15"
        />
      ...
      <div className="flex justify-center mt-10">
        <p className="text-white font-secondary ">
          © 2025 Doubtshell. Built with ❤️ for Students.
        </p>
      </div>
    </div>
  );
